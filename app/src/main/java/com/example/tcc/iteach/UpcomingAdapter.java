...
public class UpcomingAdapter extends ArrayAdapter<String> {
    ...
    public UpcomingAdapter(Context context, ArrayList<String> records) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.upcoming_content, parent, false);
        }
